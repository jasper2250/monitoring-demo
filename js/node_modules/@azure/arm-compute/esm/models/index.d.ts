...
/**
 * An interface representing CapacityReservationGroupInstanceView.
 */
...
/**
 * Specifies information about the capacity reservation group that the capacity reservations should
 * be assigned to. <br><br> Currently, a capacity reservation can only be added to a capacity
 * reservation group at creation time. An existing capacity reservation cannot be added or moved to
 * another capacity reservation group.
 */
...
export interface CapacityReservation extends Resource {
    ...
    /**
     * SKU of the resource for which capacity needs be reserved. The SKU name and capacity is
     * required to be set. Currently VM Skus with the capability called
...
/**
 * Specifies the Spot-Try-Restore properties for the virtual machine scale set. <br><br> With this
 * property customer can enable or disable automatic restore of the evicted Spot VMSS VM instances
...
export interface VirtualMachineScaleSetVMProfile {
    ...
    userData?: string;
    /**
     * Specifies the capacity reservation related details of a scale set. <br><br>Minimum
 ...
 * Optional Parameters.
 */
export interface CapacityReservationGroupsGetOptionalParams extends msRest.RequestOptionsBase {
    /**
     * The expand expression to apply on the operation. 'InstanceView' will retrieve the list of
     * instance views of the capacity reservations under the capacity reservation group which is a
     * snapshot of the runtime properties of a capacity reservation that is managed by the platform
 ...
 * Optional Parameters.
 */
export interface CapacityReservationGroupsListByResourceGroupOptionalParams extends msRest.RequestOptionsBase {
    /**
     * The expand expression to apply on the operation. Based on the expand param(s) specified we
     * return Virtual Machine or ScaleSet VM Instance or both resource Ids which are associated to
     * capacity reservation group in the response. Possible values include:
 ...
 * Optional Parameters.
 */
export interface CapacityReservationGroupsListBySubscriptionOptionalParams extends msRest.RequestOptionsBase {
    /**
     * The expand expression to apply on the operation. Based on the expand param(s) specified we
     * return Virtual Machine or ScaleSet VM Instance or both resource Ids which are associated to
     * capacity reservation group in the response. Possible values include:
 ...
 * Optional Parameters.
 */
export interface CapacityReservationGroupsListByResourceGroupNextOptionalParams extends msRest.RequestOptionsBase {
    /**
     * The expand expression to apply on the operation. Based on the expand param(s) specified we
     * return Virtual Machine or ScaleSet VM Instance or both resource Ids which are associated to
     * capacity reservation group in the response. Possible values include:
 ...
 * Optional Parameters.
 */
export interface CapacityReservationGroupsListBySubscriptionNextOptionalParams extends msRest.RequestOptionsBase {
    /**
     * The expand expression to apply on the operation. Based on the expand param(s) specified we
     * return Virtual Machine or ScaleSet VM Instance or both resource Ids which are associated to
     * capacity reservation group in the response. Possible values include:
 ...
 * Optional Parameters.
 */
export interface CapacityReservationsGetOptionalParams extends msRest.RequestOptionsBase {
    /**
     * The expand expression to apply on the operation. 'InstanceView' retrieves a snapshot of the
     * runtime properties of the capacity reservation that is managed by the platform and can change
     * outside of control plane operations. Possible values include: 'instanceView'
     */
 ...
 * @extends Array<CapacityReservationGroup>
 */
export interface CapacityReservationGroupListResult extends Array<CapacityReservationGroup> {
    /**
     * The URI to fetch the next page of capacity reservation groups. Call ListNext() with this URI
     * to fetch the next page of capacity reservation groups.
     */
    nextLink?: string;
}
/**
 ...
 * @extends Array<CapacityReservation>
 */
export interface CapacityReservationListResult extends Array<CapacityReservation> {
    /**
     * The URI to fetch the next page of capacity reservations. Call ListNext() with this URI to
     * fetch the next page of capacity reservations.
     */
    nextLink?: string;
}
/**
 ...
 * @enum {string}
 */
export declare type StorageAccountTypes = 'Standard_LRS' | 'Premium_LRS' | 'StandardSSD_LRS' | 'UltraSSD_LRS' | 'Premium_ZRS' | 'StandardSSD_ZRS';
/**
 ...
 * @enum {string}
 */
export declare type PassNames = 'OobeSystem';
/**
 ...
 * @enum {string}
 */
export declare type ComponentNames = 'Microsoft-Windows-Shell-Setup';
/**
 ...
 * @enum {string}
 */
export declare type WindowsVMGuestPatchMode = 'Manual' | 'AutomaticByOS' | 'AutomaticByPlatform';
/**
 ...
 * @enum {string}
 */
export declare type WindowsPatchAssessmentMode = 'ImageDefault' | 'AutomaticByPlatform';
/**
 ...
 * @enum {string}
 */
export declare type LinuxVMGuestPatchMode = 'ImageDefault' | 'AutomaticByPlatform';
/**
 ...
 * @enum {string}
 */
export declare type LinuxPatchAssessmentMode = 'ImageDefault' | 'AutomaticByPlatform';
/**
 ...
 * @enum {string}
 */
export declare type SecurityTypes = 'TrustedLaunch';
/**
 ...
 * @enum {string}
 */
export declare type ConsistencyModeTypes = 'CrashConsistent' | 'FileSystemConsistent' | 'ApplicationConsistent';
/**
 ...
 * @enum {string}
 */
export declare type VmDiskTypes = 'None' | 'Unmanaged';
/**
 ...
 * @enum {string}
 */
export declare type HyperVGenerationTypes = 'V1' | 'V2';
/**
 ...
 * @enum {string}
 */
export declare type AvailabilitySetSkuTypes = 'Classic' | 'Aligned';
/**
 ...
 * @enum {string}
 */
export declare type ProximityPlacementGroupType = 'Standard' | 'Ultra';
/**
 ...
 * @enum {string}
 */
export declare type VMGuestPatchRebootBehavior = 'Unknown' | 'NeverReboots' | 'AlwaysRequiresReboot' | 'CanRequestReboot';
/**
 ...
 * @enum {string}
 */
export declare type PatchAssessmentState = 'Unknown' | 'Available';
/**
 ...
 * @enum {string}
 */
export declare type PatchOperationStatus = 'Unknown' | 'InProgress' | 'Failed' | 'Succeeded' | 'CompletedWithWarnings';
/**
 ...
 * @enum {string}
 */
export declare type VMGuestPatchRebootSetting = 'IfRequired' | 'Never' | 'Always';
/**
 ...
 * @enum {string}
 */
export declare type VMGuestPatchClassificationWindows = 'Critical' | 'Security' | 'UpdateRollUp' | 'FeaturePack' | 'ServicePack' | 'Definition' | 'Tools' | 'Updates';
/**
 ...
 * @enum {string}
 */
export declare type VMGuestPatchClassificationLinux = 'Critical' | 'Security' | 'Other';
/**
 ...
 * @enum {string}
 */
export declare type VMGuestPatchRebootStatus = 'Unknown' | 'NotNeeded' | 'Required' | 'Started' | 'Failed' | 'Completed';
/**
 ...
 * @enum {string}
 */
export declare type PatchInstallationState = 'Unknown' | 'Installed' | 'Failed' | 'Excluded' | 'NotSelected' | 'Pending';
/**
 ...
 * @enum {string}
 */
export declare type DiskCreateOptionTypes = 'FromImage' | 'Empty' | 'Attach';
/**
 ...
 * @enum {string}
 */
export declare type DiskDetachOptionTypes = 'ForceDetach';
/**
 ...
 * @enum {string}
 */
export declare type DiskDeleteOptionTypes = 'Delete' | 'Detach';
/**
 ...
 * @enum {string}
 */
export declare type DiffDiskOptions = 'Local';
/**
 ...
 * @enum {string}
 */
export declare type DiffDiskPlacement = 'CacheDisk' | 'ResourceDisk';
/**
 ...
 * @enum {string}
 */
export declare type IPVersions = 'IPv4' | 'IPv6';
/**
 ...
 * @enum {string}
 */
export declare type PublicIPAllocationMethod = 'Dynamic' | 'Static';
/**
 ...
 * @enum {string}
 */
export declare type NetworkApiVersion = '2020-11-01';
/**
 ...
 * @enum {string}
 */
export declare type VirtualMachinePriorityTypes = 'Regular' | 'Low' | 'Spot';
/**
 ...
 * @enum {string}
 */
export declare type VirtualMachineEvictionPolicyTypes = 'Deallocate' | 'Delete';
/**
 ...
 * @enum {string}
 */
export declare type HyperVGenerationType = 'V1' | 'V2';
/**
 ...
 * @enum {string}
 */
export declare type VirtualMachineScaleSetScaleInRules = 'Default' | 'OldestVM' | 'NewestVM';
/**
 ...
 * @enum {string}
 */
export declare type OrchestrationMode = 'Uniform' | 'Flexible';
/**
 ...
 * @enum {string}
 */
export declare type OrchestrationServiceNames = 'AutomaticRepairs';
/**
 ...
 * @enum {string}
 */
export declare type OrchestrationServiceState = 'NotRunning' | 'Running' | 'Suspended';
/**
 ...
 * @enum {string}
 */
export declare type OrchestrationServiceStateAction = 'Resume' | 'Suspend';
/**
 ...
 * @enum {string}
 */
export declare type ExecutionState = 'Unknown' | 'Pending' | 'Running' | 'Failed' | 'Succeeded' | 'TimedOut' | 'Canceled';
/**
 ...
 * @enum {string}
 */
export declare type DiskStorageAccountTypes = 'Standard_LRS' | 'Premium_LRS' | 'StandardSSD_LRS' | 'UltraSSD_LRS' | 'Premium_ZRS' | 'StandardSSD_ZRS';
/**
 ...
 * @enum {string}
 */
export declare type HyperVGeneration = 'V1' | 'V2';
/**
 ...
 * @enum {string}
 */
export declare type DiskCreateOption = 'Empty' | 'Attach' | 'FromImage' | 'Import' | 'Copy' | 'Restore' | 'Upload';
/**
 ...
 * @enum {string}
 */
export declare type DiskState = 'Unattached' | 'Attached' | 'Reserved' | 'ActiveSAS' | 'ReadyToUpload' | 'ActiveUpload';
/**
 ...
 * @enum {string}
 */
export declare type EncryptionType = 'EncryptionAtRestWithPlatformKey' | 'EncryptionAtRestWithCustomerKey' | 'EncryptionAtRestWithPlatformAndCustomerKeys';
/**
 ...
 * @enum {string}
 */
export declare type NetworkAccessPolicy = 'AllowAll' | 'AllowPrivate' | 'DenyAll';
/**
 ...
 * @enum {string}
 */
export declare type DiskSecurityTypes = 'TrustedLaunch';
/**
 ...
 * @enum {string}
 */
export declare type SnapshotStorageAccountTypes = 'Standard_LRS' | 'Premium_LRS' | 'Standard_ZRS';
/**
 ...
 * @enum {string}
 */
export declare type DiskEncryptionSetType = 'EncryptionAtRestWithCustomerKey' | 'EncryptionAtRestWithPlatformAndCustomerKeys';
/**
 ...
 * @enum {string}
 */
export declare type AccessLevel = 'None' | 'Read' | 'Write';
/**
 ...
 * @enum {string}
 */
export declare type DiskEncryptionSetIdentityType = 'SystemAssigned' | 'None';
/**
 ...
 * @enum {string}
 */
export declare type GallerySharingPermissionTypes = 'Private' | 'Groups';
/**
 ...
 * @enum {string}
 */
export declare type SharingProfileGroupTypes = 'Subscriptions' | 'AADTenants';
/**
 ...
 * @enum {string}
 */
export declare type AggregatedReplicationState = 'Unknown' | 'InProgress' | 'Completed' | 'Failed';
/**
 ...
 * @enum {string}
 */
export declare type ReplicationState = 'Unknown' | 'Replicating' | 'Completed' | 'Failed';
/**
 ...
 * @enum {string}
 */
export declare type StorageAccountType = 'Standard_LRS' | 'Standard_ZRS' | 'Premium_LRS';
/**
 ...
 * @enum {string}
 */
export declare type SharingUpdateOperationTypes = 'Add' | 'Remove' | 'Reset';
/**
 ...
 * @enum {string}
 */
export declare type CloudServiceUpgradeMode = 'Auto' | 'Manual' | 'Simultaneous';
/**
 ...
 * @enum {string}
 */
export declare type RestorePointCollectionExpandOptions = 'restorePoints';
/**
 ...
 * @enum {string}
 */
export declare type CapacityReservationGroupInstanceViewTypes = 'instanceView';
/**
 * Defines values for ExpandTypesForGetCapacityReservationGroups.
 * Possible values include: 'virtualMachineScaleSetVMs/$ref', 'virtualMachines/$ref'
 * @readonly
 * @enum {string}
 */
export declare type ExpandTypesForGetCapacityReservationGroups = 'virtualMachineScaleSetVMs/$ref' | 'virtualMachines/$ref';
/**
 ...
 * @enum {string}
 */
export declare type CapacityReservationInstanceViewTypes = 'instanceView';
/**
 ...
 * @enum {string}
 */
export declare type ExpandTypesForGetVMScaleSets = 'userData';
/**
 ...
 * @enum {string}
 */
export declare type SelectPermissions = 'Permissions';
/**
 ...
 * @enum {string}
 */
export declare type ReplicationStatusTypes = 'ReplicationStatus';
/**
 ...
 * @enum {string}
 */
export declare type SharedToValues = 'tenant';
/**
 ...
 * @enum {string}
 */
export declare type ProvisioningState = 'Creating' | 'Updating' | 'Failed' | 'Succeeded' | 'Deleting' | 'Migrating';
/**
 ...
 * @enum {string}
 */
export declare type ProvisioningState1 = 'Creating' | 'Updating' | 'Failed' | 'Succeeded' | 'Deleting' | 'Migrating';
/**
 ...
 * @enum {string}
 */
export declare type ProvisioningState2 = 'Creating' | 'Updating' | 'Failed' | 'Succeeded' | 'Deleting' | 'Migrating';
/**
 ...
 * @enum {string}
 */
export declare type ProvisioningState3 = 'Creating' | 'Updating' | 'Failed' | 'Succeeded' | 'Deleting' | 'Migrating';
/**
 ...
 */
export declare type DedicatedHostsBeginCreateOrUpdateResponse = DedicatedHost & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type DedicatedHostsBeginUpdateResponse = DedicatedHost & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the list operation.
 */
export declare type VirtualMachineImagesEdgeZoneListResponse = Array<VirtualMachineImageResource> & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listOffers operation.
 */
export declare type VirtualMachineImagesEdgeZoneListOffersResponse = Array<VirtualMachineImageResource> & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listPublishers operation.
 */
export declare type VirtualMachineImagesEdgeZoneListPublishersResponse = Array<VirtualMachineImageResource> & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listSkus operation.
 */
export declare type VirtualMachineImagesEdgeZoneListSkusResponse = Array<VirtualMachineImageResource> & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type VirtualMachinesBeginAssessPatchesResponse = VirtualMachineAssessPatchesResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type VirtualMachinesBeginInstallPatchesResponse = VirtualMachineInstallPatchesResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type RestorePointsBeginCreateResponse = RestorePoint & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
...
export declare type CapacityReservationGroupsCreateOrUpdateResponse = CapacityReservationGroup & {
    ...
    _response: msRest.HttpResponse & {
         ...
         * The response body as parsed JSON or XML
         */
        parsedBody: CapacityReservationGroup;
    };
};
/**
 * Contains response data for the update operation.
...
export declare type CapacityReservationGroupsListByResourceGroupResponse = CapacityReservationGroupListResult & {
    ...
    _response: msRest.HttpResponse & {
         ...
         * The response body as parsed JSON or XML
         */
        parsedBody: CapacityReservationGroupListResult;
    };
};
/**
 * Contains response data for the listBySubscription operation.
...
export declare type CapacityReservationsCreateOrUpdateResponse = CapacityReservation & {
    ...
    _response: msRest.HttpResponse & {
         ...
         * The response body as parsed JSON or XML
         */
        parsedBody: CapacityReservation;
    };
};
/**
 * Contains response data for the update operation.
...
export declare type CapacityReservationsListByCapacityReservationGroupResponse = CapacityReservationListResult & {
    ...
    _response: msRest.HttpResponse & {
         ...
         * The response body as parsed JSON or XML
         */
        parsedBody: CapacityReservationListResult;
    };
};
/**
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type CapacityReservationsBeginCreateOrUpdateResponse = CapacityReservation & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type CapacityReservationsBeginUpdateResponse = CapacityReservation & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type VirtualMachineScaleSetExtensionsBeginUpdateResponse = VirtualMachineScaleSetExtension & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type VirtualMachineScaleSetVMExtensionsBeginCreateOrUpdateResponse = VirtualMachineScaleSetVMExtension & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type VirtualMachineScaleSetVMExtensionsBeginUpdateResponse = VirtualMachineScaleSetVMExtension & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type VirtualMachineRunCommandsBeginCreateOrUpdateResponse = VirtualMachineRunCommand & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type VirtualMachineRunCommandsBeginUpdateResponse = VirtualMachineRunCommand & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type VirtualMachineScaleSetVMRunCommandsBeginCreateOrUpdateResponse = VirtualMachineRunCommand & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type VirtualMachineScaleSetVMRunCommandsBeginUpdateResponse = VirtualMachineRunCommand & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type DiskEncryptionSetsBeginCreateOrUpdateResponse = DiskEncryptionSet & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type DiskEncryptionSetsBeginUpdateResponse = DiskEncryptionSet & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type DiskAccessesBeginCreateOrUpdateResponse = DiskAccess & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type DiskAccessesBeginUpdateResponse = DiskAccess & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type DiskAccessesBeginUpdateAPrivateEndpointConnectionResponse = PrivateEndpointConnection & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginGrantAccess operation.
 */
export declare type DiskRestorePointBeginGrantAccessResponse = AccessUri & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type GalleriesBeginCreateOrUpdateResponse = Gallery & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type GalleriesBeginUpdateResponse = Gallery & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type GalleryImagesBeginCreateOrUpdateResponse = GalleryImage & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type GalleryImagesBeginUpdateResponse = GalleryImage & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type GalleryImageVersionsBeginCreateOrUpdateResponse = GalleryImageVersion & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type GalleryImageVersionsBeginUpdateResponse = GalleryImageVersion & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type GalleryApplicationsBeginCreateOrUpdateResponse = GalleryApplication & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type GalleryApplicationsBeginUpdateResponse = GalleryApplication & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type GalleryApplicationVersionsBeginCreateOrUpdateResponse = GalleryApplicationVersion & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type GalleryApplicationVersionsBeginUpdateResponse = GalleryApplicationVersion & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type GallerySharingProfileBeginUpdateResponse = SharingUpdate & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the getInstanceView operation.
 */
export declare type CloudServiceRoleInstancesGetInstanceViewResponse = RoleInstanceInstanceView & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export declare type CloudServicesBeginCreateOrUpdateResponse = CloudService & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginUpdate operation.
 */
export declare type CloudServicesBeginUpdateResponse = CloudService & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
